...
@endsection
        ...
        @section('content')
                        ...
                        <a href="/suplier/form/" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
                    ...
                    <tbody>
                        <tr>
                            <td>kode suplier</td>
                            <th scope="row">{{$item->kdsuplier}}</th>
                        </tr>
                        <tr>
                            <td>Nama suplier</td>
                    ...
                    <a href="/suplier/edit/{{$item->id}}" class="btn btn-info btn-xs"><i class="fa fa-pencil-alt"></i></a>
